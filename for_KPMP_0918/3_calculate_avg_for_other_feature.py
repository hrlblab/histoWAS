...
result_path="/home/yangy50/project/pywasphe/PyWasPhe/"
wsi_data_path="/home/yangy50/project/pywasphe/PyWasPhe/result/concate_csv_topology/"
whole_feature_path="/home/yangy50/Desktop/nnUnetVSself/KPMP_data/Urine_Biomarker_Data-BC_AU5812-2022/OP-BC_AU5812-Urine_Biomarker_Data-2022.csv"

# read the whole_feature csv
whole_feature = pd.read_csv(whole_feature_path, usecols=['Biopsy ID: ', 'ACR (mg/g)'])

# read the topology feature
topology_feature=pd.read_csv("/home/yangy50/project/pywasphe/PyWasPhe/topology_feature_final.csv")
...
for index, row in whole_feature.iterrows():
    ...
    # This is for batch 1
    column_means = wsi_data_df.drop(
        columns=["compartment_ids","wsi_id", "x1", "y1", "x2", "y2", "topology_x", "topology_y"]).mean(
        skipna=True)
...
result_csv.to_csv(result_path+"whole_feature_final_ACR.csv", index=False)
