...
# 读取数据
data = pd.read_csv('/home/yangy50/project/pywasphe/PyWasPhe/whole_feature_final_eGFR.csv')
...
# 定义Spatial特征的关键词
spatial_keywords = ['ANN', 'g_function', 'K_function', 'L_function','G_function',"F_function",'J_function']
...
plot_manhattan_feature_categorized(regressions_df,
                               thresh=threshold_value,
                                show_num=20,
                               save="result/Manhattan_demo_topology_category_final_eGFR_20.png",
                               save_format="png")
